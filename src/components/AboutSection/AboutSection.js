				...
				<div className='aboutSection_content'>
					...
					<div className='aboutSection_wrapper'>
						<div className='aboutSection_tile'>
							<p><strong>Little Lemon</strong> is a small restaurant in the heart of <strong>Chicago</strong>.</p>
							<p>We are known for our Chicago style feta cheese and our authentic cuisine.</p>
							<p>We have been serving the people of Chicago for <strong>over 20 years</strong> and we are proud to be a part of the local community.</p>
						</div>
